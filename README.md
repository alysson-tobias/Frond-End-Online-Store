...
<details>
  ...
  * São `04` dias de projeto;
  * Data para entrega final do projeto: `20/09/2022 13:50`.
...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-t24-a-project-frontend-online-store.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-t24-a-project-frontend-online-store`
  ...
  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-t24-a-project-frontend-online-store/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-t24-a-project-frontend-online-store/pulls) e confira que o seu _Pull Request_ está criado
